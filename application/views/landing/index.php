...
<head>
    ...
    <!-- Favicons -->
    <link href=" <?= base_url('landing/pages/assets/img/doctor.png') ?>" rel="icon">
    <link href="  <?= base_url('landing/pages/assets/img/apple-touch-icon.png') ?>" rel="apple-touch-icon">

    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

    <!-- Vendor CSS Files -->
    <link href=" <?= base_url('landing/pages/assets/vendor/aos/aos.css'); ?>" rel="stylesheet">
    <link href="<?= base_url('landing/pages/assets/vendor/bootstrap/css/bootstrap.min.css') ?>" rel="stylesheet">
    <link href="<?= base_url('landing/pages/assets/vendor/bootstrap-icons/bootstrap-icons.css') ?> " rel="stylesheet">
    <link href="<?= base_url('landing/pages/assets/vendor/boxicons/css/boxicons.min.css') ?>" rel="stylesheet">
    <link href="<?= base_url('landing/pages/assets/vendor/glightbox/css/glightbox.min.css') ?>" rel="stylesheet">
    <link href="<?= base_url('landing/pages/assets/vendor/swiper/swiper-bundle.min.css') ?>" rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href="  <?= base_url('landing/pages/assets/css/style.css') ?>" rel="stylesheet">
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <div class="logo me-auto">
                <h1><a href="index.html">Consult-app</a></h1>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li>
                        <a class="nav-link scrollto" href="<?= base_url('AuthController') ?>">Login</a>
                    </li>
                </ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left">
                    <img src="<?= base_url('landing/pages/assets/img/apps.png') ?>" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    ...
    <main id="main">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in">
                        <div class="tab-content">
                            <div class="tab-pane active show" id="tab-1">
                                <figure>
                                    <img src="<?= base_url('landing/pages/assets/img/daftar.png') ?>" alt="" class="img-fluid">
                                </figure>
                            </div>
                            <div class="tab-pane" id="tab-2">
                                <figure>
                                    <img src="<?= base_url('landing/pages/assets/img/login.png') ?>" alt="" class="img-fluid">
                                </figure>
                            </div>
                            <div class="tab-pane" id="tab-3">
                                <figure>
                                    <img src="<?= base_url('landing/pages/assets/img/konsultasi.png') ?>" alt="" class="img-fluid">
                                </figure>
                            </div>
                            <div class="tab-pane" id="tab-4">
                                <figure>
                                    <img src="<?= base_url('landing/pages/assets/img/solusi.png') ?>" alt="" class="img-fluid">
                                </figure>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Vendor JS Files -->
        <script src="<?= base_url('landing/pages/assets/vendor/aos/aos.js') ?>"></script>
        <script src="<?= base_url('landing/pages/assets/vendor/bootstrap/js/bootstrap.bundle.min.js') ?>"></script>
        <script src="<?= base_url('landing/pages/assets/vendor/glightbox/js/glightbox.min.js') ?>"></script>
        <script src="<?= base_url('landing/pages/assets/vendor/isotope-layout/isotope.pkgd.min.js') ?>"></script>
        <script src="<?= base_url('landing/pages/assets/vendor/swiper/swiper-bundle.min.js') ?>"></script>
        <script src="<?= base_url('landing/pages/assets/vendor/php-email-form/validate.js') ?>"></script>

        <!-- Template Main JS File -->
        <script src="<?= base_url('landing/pages/assets/js/main.js') ?>"></script>
