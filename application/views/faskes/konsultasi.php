<div class="row">
    ...
    <script>
        ...
        function showForm(id) {
            $(".form").append(`
                        <form id="form-chat" class="form-chat" method="post" action="<?= base_url('FaskesController/post_chat'); ?>">
                            <div class="row">
                                <div class="col-md-10">
                ...
                success: function(response) {
                    $.each(response.data, function(key, item) {
                        if (item.pengirim == "Pasien") {
                            if (item.tipe == "file") {
                                $("#card-body").append(`
                                    <div class='card bg-success' id='isi' style='padding: 0.5em; width: 90%'><img src="../assets/upload/` + item.pesan + `" /></div>
                                `);
                            } else {
                                $("#card-body").append(`
