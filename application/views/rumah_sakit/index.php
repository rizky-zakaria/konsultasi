    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                ...
                if ($role == "dokter") {
                ?>
                    <a href="<?= base_url($controller . '/formTambahDokter'); ?>" class="btn btn-primary float-right">Tambah</a>
                <?php
                } else {
                ?>
                    <a href="<?= base_url($controller . '/formTambahPerawat'); ?>" class="btn btn-primary float-right">Tambah</a>
                <?php
                }
                ?>
